<template>
  <div>
    <div v-if="profileImage">
      ...
      <div class="block relative h-40 w-40 mx-auto text-gray-500  rounded-full">
        ...
        <span @click="profileImageSettings = !profileImageSettings" class="select-none absolute right-0 bottom-2 bg-white rounded-full p-2 border shadow-lg cursor-pointer">
    ...
    <div v-else>
      ...
      <input @change="setProfileImage" type="file" id="image" accept="image/*" class="hidden">
    </div>
  </div>
</template>
